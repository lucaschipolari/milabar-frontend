...
const SocialIcons = () => {
  return (
    <div className="social-icons">
      <Link className="all-bg-color rounded-4 p-2 text-decoration-none d-flex align-items-center mb-2 border-primary" to="/404">
      ...
      <Link className="all-bg-color rounded-4 p-2 d-flex justify-content-around align-items-center text-decoration-none border-primary" to="/404">
