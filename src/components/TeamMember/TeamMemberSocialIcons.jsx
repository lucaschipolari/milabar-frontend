...
import { faFacebookF, faGithub, faInstagram, faGoogle } from "@fortawesome/free-brands-svg-icons";
...
const TeamMemberSocialIcons = ({ github, instagram, facebook, google }) => {
  return (
    <div className="social-icons">
      ...
      <a href={google} className="social-icon" aria-label="Google" target="_blank" rel="noreferrer">
